...
class ActorNetwork:
	...
	def load_network(self):
		...
		checkpoint = tf.train.get_checkpoint_state("saved_actor_networks_poten")
	...
	def save_network(self,time_step):
		...
		self.saver.save(self.sess, 'saved_actor_networks_poten/' + 'actor-network', global_step = time_step)
